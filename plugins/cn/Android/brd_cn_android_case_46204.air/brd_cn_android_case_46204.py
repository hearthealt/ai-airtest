...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zdtc.www")
        dd.sleep(3)
        dd.click(Template(r"tpl1740017558362.png", record_pos=(0.208, 0.235), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1740017567397.png", record_pos=(0.033, -0.399), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.sleep(3)
        dd.click(Template(r"tpl1740017594032.png", record_pos=(-0.409, 0.476), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1740017633253.png", record_pos=(0.263, -0.225), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1740017654486.png", record_pos=(-0.02, -0.766), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
