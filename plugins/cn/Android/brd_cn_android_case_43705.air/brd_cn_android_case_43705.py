...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.rydinfo.driver")
        dd.sleep(3)
        dd.click(Template(r"tpl1734508146494.png", record_pos=(-0.005, 0.201), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734508176598.png", record_pos=(0.248, 0.965), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734508183319.png", record_pos=(-0.438, -0.119), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734508187244.png", record_pos=(-0.244, -0.472), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1734508194164.png", record_pos=(0.296, -0.245), resolution=(1220, 2712)))
        #dd.sleep()
        dd.add(Template(r"tpl1734508278615.png", record_pos=(-0.001, -0.003), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
