...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("us.xiumi.editor") 
        dd.sleep(3)
        dd.click(Template(r"tpl1740378820294.png", record_pos=(0.16, 0.447), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1743405321788.png", record_pos=(-0.011, -0.069), resolution=(1220, 2712)),msg="阻断失败")
