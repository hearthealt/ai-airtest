...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.foundersc.app.xf")
        dd.sleep(3)
        dd.click(Template(r"tpl1736821423555.png", record_pos=(0.169, 0.575), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1736821432459.png", record_pos=(0.396, -0.926), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1736821448423.png", record_pos=(0.006, 0.729), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1736821473986.png", record_pos=(0.0, 1.008), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1736821486872.png", record_pos=(0.003, 0.648), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
