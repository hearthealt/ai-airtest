...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.weaver.teams")
        dd.sleep(5)
        dd.click(Template(r"tpl1736835885232.png", record_pos=(0.202, 0.532), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1736835936420.png", record_pos=(0.0, -0.07), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
