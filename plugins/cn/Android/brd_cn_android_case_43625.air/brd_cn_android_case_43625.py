...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zzbj.zblmapp")
        dd.sleep(3)
        dd.click(Template(r"tpl1734502966737.png", record_pos=(0.118, 0.593), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734502972842.png", record_pos=(-0.354, 0.183), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734502978766.png", record_pos=(-0.035, -0.412), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1734502984955.png", record_pos=(-0.066, -0.297), resolution=(1220, 2712)))
        dd.text("Test1735860")
        dd.click(Template(r"tpl1734503113129.png", record_pos=(-0.003, -0.052), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734503157051.png", record_pos=(0.004, -0.03), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
