...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.rc95.D9DF4B0")
        dd.sleep(3)
        dd.click(Template(r"tpl1734507707561.png", record_pos=(0.167, 0.261), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507711288.png", record_pos=(0.012, 0.062), resolution=(1220, 2712)))
        dd.sleep(30)
        dd.add(Template(r"tpl1734507718551.png", record_pos=(-0.111, -0.057), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
