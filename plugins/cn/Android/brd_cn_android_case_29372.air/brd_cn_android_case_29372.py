...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("app.ehafo")
        dd.click(Template(r"tpl1766041168810.png", record_pos=(0.004, 0.347), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1739865215096.png", record_pos=(0.009, 0.06), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1757395188720.png", record_pos=(0.007, -0.595), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
