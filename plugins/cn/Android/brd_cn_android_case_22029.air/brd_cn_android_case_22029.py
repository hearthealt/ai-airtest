...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.hpbr.directhires")
        dd.sleep(3)
        dd.click(Template(r"tpl1740379790895.png", record_pos=(0.171, 0.558), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1740379803962.png", record_pos=(-0.127, -0.59), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1740379863210.png", record_pos=(-0.405, -0.255), resolution=(1220, 2712)))
        dd.sleep(3)
        #dd.swipe(direction="left")
        dd.click(Template(r"tpl1740379899735.png", record_pos=(0.004, -0.397), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1740379968345.png", record_pos=(-0.015, -0.532), resolution=(1220, 2712)),msg="阻断失败")  
