...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.qdpcq.pcqpro")
        dd.sleep(3)
        dd.click(Template(r"tpl1734507077063.png", record_pos=(0.171, 0.267), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507081846.png", record_pos=(-0.005, 0.056), resolution=(1220, 2712)))
        dd.sleep(30)
        dd.add(Template(r"tpl1748927766067.png", record_pos=(-0.013, -0.713), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1748927773398.png", record_pos=(0.002, 1.007), resolution=(1220, 2712)))
        dd.sleep(10)
        dd.add(Template(r"tpl1748927780672.png", record_pos=(-0.003, -0.516), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
