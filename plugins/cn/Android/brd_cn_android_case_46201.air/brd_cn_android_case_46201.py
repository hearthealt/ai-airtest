...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zhipuai.qingyan")
        dd.sleep(3)
        dd.click(Template(r"tpl1739866611169.png", record_pos=(0.188, 0.349), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1739866620884.png", record_pos=(-0.052, -0.354), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1739866745773.png", record_pos=(-0.389, -0.009), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1739866754183.png", record_pos=(0.003, -0.128), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1739866783384.png", record_pos=(0.011, -0.439), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
