...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.netease.enterprise.work")
        dd.sleep(5)
        dd.click(Template(r"tpl1736824702375.png", record_pos=(0.213, 0.233), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1736824710550.png", record_pos=(-0.262, 0.776), resolution=(1220, 2712)))
        dd.sleep(3)
        dd.click(Template(r"tpl1736824731132.png", record_pos=(-0.198, -0.459), resolution=(1220, 2712)))
        dd.text("3694613499@qq.com")
        dd.click(Template(r"tpl1736824737570.png", record_pos=(-0.219, -0.307), resolution=(1220, 2712)))
        dd.text("Zag1,lp-@123")
        dd.sleep(5)
        dd.click(Template(r"tpl1736824750950.png", record_pos=(-0.402, -0.171), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1736824868681.png", record_pos=(-0.003, -0.052), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1736824904732.png", record_pos=(0.009, -0.353), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
