...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.ivydad.readtool")
        dd.sleep(3)
        dd.click(Template(r"tpl1739864899828.png", record_pos=(-0.297, 0.346), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1739864909286.png", record_pos=(0.0, 0.152), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1739864946939.png", record_pos=(0.006, -0.717), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
