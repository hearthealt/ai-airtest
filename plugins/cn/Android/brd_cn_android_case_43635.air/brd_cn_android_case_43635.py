...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.pbb.release")
        dd.sleep(3)
        dd.click(Template(r"tpl1734504744451.png", record_pos=(0.001, 0.335), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734504764860.png", record_pos=(-0.012, 0.69), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1734504774607.png", record_pos=(-0.206, 0.997), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734504782035.png", record_pos=(-0.012, 0.729), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
