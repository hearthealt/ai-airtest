...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.linwq.ydw")
        dd.sleep(3)
        dd.click(Template(r"tpl1734506612268.png", record_pos=(0.002, 0.058), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734506616518.png", record_pos=(0.019, 0.16), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734506623074.png", record_pos=(-0.122, 1.013), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734506636028.png", record_pos=(-0.201, -0.544), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1734506642765.png", record_pos=(-0.233, -0.418), resolution=(1220, 2712)))
        dd.text("Test1735860")
        dd.click(Template(r"tpl1734506674302.png", record_pos=(0.011, -0.256), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734506700553.png", record_pos=(0.002, -0.397), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
