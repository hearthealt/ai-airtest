...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zyzc.mgb")
        dd.sleep(3)
        dd.click(Template(r"tpl1734502646149.png", record_pos=(-0.011, 0.065), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.click(Template(r"tpl1736131919022.png", record_pos=(0.011, 0.301), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1736131968125.png", record_pos=(-0.232, -0.546), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1736132042912.png", record_pos=(0.357, -0.399), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1736132080469.png", record_pos=(-0.056, 0.002), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
