...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.rrxxjob.H578CB895")
        dd.sleep(3)
        dd.click(Template(r"tpl1734507899332.png", record_pos=(-0.016, 0.187), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507905449.png", record_pos=(0.007, 0.059), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734507938309.png", record_pos=(0.011, 0.646), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1734507948613.png", record_pos=(-0.205, 0.994), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734507958440.png", record_pos=(0.015, 0.744), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507967347.png", record_pos=(0.2, 0.995), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
