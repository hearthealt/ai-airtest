...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.jobxinpg.NI2DD730B")
        dd.sleep(3)
        dd.click(Template(r"tpl1734506390941.png", record_pos=(0.002, 0.2), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1759990358586.png", record_pos=(0.018, 0.395), resolution=(1220, 2712)),msg="阻断失败")  
#         dd.click(Template(r"tpl1734506428955.png", record_pos=(-0.207, 1.013), resolution=(1220, 2712)))
#         #dd.sleep()
#         dd.add(Template(r"tpl1734506434973.png", record_pos=(-0.017, 0.648), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
