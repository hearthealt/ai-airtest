...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.tzlyrc.H525AD44E")
        dd.sleep(3)
        dd.click(Template(r"tpl1734508592552.png", record_pos=(0.008, 0.212), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734508619417.png", record_pos=(0.004, -0.009), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
