...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zzw.join")
        dd.sleep(3)
        dd.click(Template(r"tpl1734504430072.png", record_pos=(0.002, 0.48), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1734504447038.png", record_pos=(0.032, -0.009), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
