...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zzrb.fuxishanapp")
        dd.sleep(3)
        dd.click(Template(r"tpl1734503957726.png", record_pos=(0.011, 0.224), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734503978846.png", record_pos=(-0.03, -0.29), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
