...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zhongfu.tougu")
        dd.sleep(4)
        dd.click(Template(r"tpl1736835513652.png", record_pos=(0.195, 0.611), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1765347724252.png", record_pos=(-0.025, -0.098), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1736835569960.png", record_pos=(0.002, 1.007), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1765347746302.png", record_pos=(-0.012, 0.741), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
