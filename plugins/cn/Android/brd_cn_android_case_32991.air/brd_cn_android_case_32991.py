...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.kodcloud.kodbox")
        dd.sleep(4)
        dd.click(Template(r"tpl1736824130575.png", record_pos=(0.002, 0.32), resolution=(1220, 2712)))
        dd.sleep(15)
        dd.click(Template(r"tpl1736824161411.png", record_pos=(-0.061, -0.598), resolution=(1220, 2712)))
        dd.text("17358607087")
        dd.click(Template(r"tpl1736824169583.png", record_pos=(-0.028, -0.429), resolution=(1220, 2712)))
        dd.text("Test1735860")
        dd.click(Template(r"tpl1736824230107.png", record_pos=(0.0, -0.215), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1736824254575.png", record_pos=(-0.001, -0.41), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
