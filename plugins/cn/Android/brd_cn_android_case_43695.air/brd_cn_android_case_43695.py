...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.jobpanda.NI2DD730B")
        dd.sleep(3)
        dd.click(Template(r"tpl1734506084192.png", record_pos=(0.007, 0.205), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1759990159482.png", record_pos=(0.0, 0.384), resolution=(1220, 2712)),msg="阻断失败")  
#         dd.click(Template(r"tpl1734506103009.png", record_pos=(-0.203, 0.993), resolution=(1220, 2712)))
#         #dd.sleep()
#         dd.add(Template(r"tpl1734506221298.png", record_pos=(-0.005, 0.681), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
