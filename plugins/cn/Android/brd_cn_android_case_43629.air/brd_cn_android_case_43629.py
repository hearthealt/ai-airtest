...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("com.zztlhy.log.mclz.safe")
        dd.sleep(3)
        dd.click(Template(r"tpl1734504148737.png", record_pos=(-0.003, 0.302), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734504152784.png", record_pos=(-0.006, 0.061), resolution=(1220, 2712)))
       # dd.sleep()
        #dd.swipe(direction="left")
        dd.click(Template(r"tpl1734504159919.png", record_pos=(-0.196, 0.143), resolution=(1220, 2712)))
        #dd.click()
        dd.sleep(20)
        dd.add(Template(r"tpl1759989909926.png", record_pos=(0.02, 0.011), resolution=(1220, 2712)),msg="阻断失败")  
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
