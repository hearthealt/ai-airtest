...
def reappear_blocked(dd: object, l_class: int, dev_router: dict) -> bool or str:
    ...
    try:
        ...
        dd.start_app("io.qifenzui.com")
        dd.sleep(3)
        dd.click(Template(r"tpl1734507299162.png", record_pos=(0.008, 0.234), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734507328279.png", record_pos=(-0.007, 0.727), resolution=(1220, 2712)),msg="阻断失败")  
        dd.click(Template(r"tpl1734507339818.png", record_pos=(-0.134, 1.015), resolution=(1220, 2712)))
        dd.sleep(20)
        dd.add(Template(r"tpl1734507346812.png", record_pos=(-0.002, 0.684), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507355433.png", record_pos=(0.119, 1.004), resolution=(1220, 2712)))
        dd.click(Template(r"tpl1734507365731.png", record_pos=(-0.169, 0.131), resolution=(1220, 2712)))
        dd.add(Template(r"tpl1734507398742.png", record_pos=(-0.005, 0.707), resolution=(1220, 2712)))
        # 录制结束
        # 返回阻断结果 
        dd.clear_redundant()
        return dd.blocked()
